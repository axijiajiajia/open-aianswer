  ...
  return (
    <div className="absolute top-4 right-4 z-20">
      <button 
        ...
        aria-label={isEnglish ? 'Change Language' : isChinese ? '更改语言' : 'Cambia lingua'}
      >
      ...
      {isLanguageMenuOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-md shadow-lg py-1">
          ...
          <Link href="/it" className="block px-4 py-2 text-sm text-white hover:bg-gray-700">Italiano</Link>
        </div>
      )}
    </div>
  )
